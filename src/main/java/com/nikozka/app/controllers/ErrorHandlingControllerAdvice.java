...
class ErrorHandlingControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleSQLSyntaxErrorException(SQLSyntaxErrorException ex) throws SQLSyntaxErrorException {
        if (ex.getMessage().equals("Table 'db_test.product_entity' doesn't exist")) {
